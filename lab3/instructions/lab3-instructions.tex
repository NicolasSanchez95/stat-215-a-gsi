...
\title{Lab 3 - Parallelizing $k$-means, Stat 215A, Fall 2025\vspace{-2em}}
\date{}
...
\section{Submission}
Push a folder called \texttt{lab3} to your \texttt{stat-215-a GitHub} repository by \textbf{23:59 on Saturday, October 18th}. I will run a script that will pull from each of your GitHub repositories promptly at midnight so take care not to be late as late labs will not be accepted.
...
You are allowed to use LLMs (ChatGPT, GitHub Copilot, etc.) to help with the \textbf{coding} and writing for this lab per usual. However since coding is the primary part of this lab, there are more specific disclosure requirements.  If you use an LLM to help with coding, you must do the following:
\begin{itemize}
